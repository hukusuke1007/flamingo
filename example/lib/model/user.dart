...
import 'package:flamingo/model/storage_file.dart';
import 'package:flamingo/model/collection.dart';
import 'package:flamingo/model/counter.dart';
import 'package:flamingo/helper/helper.dart';
...
class User extends Document<User> {
  ...
  Map<String, dynamic> toData() {
    ...
    if (this.file != null) {
      if (!this.file.isDeleted) {
        data[folderName] = this.file.toJson();
      } else {
  ...
  void fromData(Map<String, dynamic> data) {
    ...
    if (isVal(data, folderName)) {
      this.file = StorageFile.fromJson(Helper.fromMap(data[folderName]));
    }
  }
